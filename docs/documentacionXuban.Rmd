...
* La librería se ha dividido en 3 scripts: el archivo `main_funcs.R` es el script principal que contiene las funciones que podran ser llamadas. El script `utils.R` contiene las funciones auxiliares que usará el script principal. Por último, `plotting.R` contiene las funciones para visualizar.
